...
namespace SpecCollector
{
    public static class SpecData
    {
        ...
        public static string ЭтажейVarName = "$Этажей";
        ...
        public static Dictionary<string, string> BOMSections = new Dictionary<string, string>
{
    { "Детали\\Крышка ригеля", "Детали" },
    { "Детали\\Крышка стойки", "Детали" },
    { "Детали\\КрышкиПрижимы\\Крышка ригеля", "Детали" },
    { "Детали\\КрышкиПрижимы\\Прижим ригеля", "Детали" },
    { "Детали\\КрышкиПрижимы\\Прижим стойки", "Детали" },
    { "Детали\\Прижим ригеля", "Детали" },
    { "Детали\\Прижим стойки", "Детали" },
    { "Детали\\Ригели", "Детали" },
    { "Детали\\Стойки", "Детали" },
    { "Детали\\Гнутые", "Детали" },
    ...
    { "Раскрой гибка", "Раскрой" },
    { "Заполнения", "Заполнения" },
    { "Заполнения\\Изделия", "Заполнения" },
    { "Заполнения\\Заполнения изделий", "Заполнения" },
